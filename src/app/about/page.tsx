    ...
    <main className="pt-24 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
        <section>
          ...
          <p>
            At ETHENZAA LOOM FASHION LLP, we believe that fashion is more than just clothing—it's a statement of confidence, heritage, and modern expression. We started our journey with a simple vision: to bring premium quality ethnic and contemporary wear to everyone who appreciates fine craftsmanship and elegant design.
          </p>
        </section>
