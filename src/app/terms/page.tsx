  ...
  return (
    <main className="pt-24 pb-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
        <p>Welcome to Ethenzaa. By accessing and using this website, you agree to comply with the following Terms & Conditions.</p>
        ...
        <section>
          ...
          <p>All content on this website, including logos, text, graphics, and images, is the property of Ethenzaa and is protected by copyright laws.</p>
        </section>

        <section>
          <h2 className="font-serif text-2xl text-primary mb-4">4. Liability</h2>
          <p>Ethenzaa shall not be liable for any indirect, incidental, or consequential damages arising from the use of our products or website.</p>
        </section>
      </div>
    </main>
  );
